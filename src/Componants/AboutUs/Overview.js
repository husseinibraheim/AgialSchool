...
function Overview() {
    ...
    const visionTitle = <h3>Our Vision</h3>;
    const visionParagraph = <> <p>  Our school is an institute with ambitious expectations, aims
    ...
    const missionTitle = <> <h3>Our Mission</h3></>
